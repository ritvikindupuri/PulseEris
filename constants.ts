...
export const INITIAL_USERS: User[] = [
  ...
  { id: 5, username: 'emt4', password: 'password', role: UserRole.EMT, status: EmtStatus.OFF_DUTY, teamId: 2, certifications: ['AEMT', 'BLS'] },
...
export const INITIAL_TEAMS: Team[] = [
  ...
  { 
    ...
    members: INITIAL_USERS.filter(u => u.id === 4 || u.id === 5),
    assignedCallId: 1,
  },
];
